...
player_rect = player.get_rect().move((50, 300))
# player_speed = [1, 1]
...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDHT, random.randint(0, 500), *enemy_size)
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(450, 550), 0, *bonus_size)
    bonus_move = [0, random.randint(1, 2)]
    return [bonus, bonus_rect, bonus_move]

CREATE_BONUS = pygame.USEREVENT + 2
pygame.time.set_timer(CREATE_BONUS, 8000)
